...
class _fasterRCNN(nn.Module):
    ...
    def forward_base_features(self, im_data, im_info, gt_boxes, num_boxes, box_info):
    ...
    def forward_pooled_feats(self, im_data, im_info, gt_boxes, num_boxes, box_info):
        batch_size = im_data.size(0)
        ...
        return pooled_feat, pooled_feat_padded
